...
st.sidebar.caption("Ajuste as faixas de alocação por classe com os controles de rolagem (0.00 a 1.00).")
...
if _prices_preview is None:
    ...
    # Initialize ranges in session_state
    ...
    # Render one range slider per asset (classe)
    new_ranges = {}
    for a in assets_list:
        ...
        # Ensure min <= max logically handled by slider; store result
